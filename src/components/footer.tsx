...
function Footer() {
  ...
  return (
    <footer className="bg-[#020202] border-t border-white/[0.05] relative">
      <div className="container mx-auto px-6 py-20">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          >
            <Link to="/" className="text-white font-bold text-3xl tracking-tight mb-6 block">
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white/[0.05] backdrop-blur-sm border border-white/[0.1] rounded-2xl flex items-center justify-center">
          ...
          >
            ...
            <div className="space-y-4">
              {services.map((service) => (
                <div key={service} className="text-white/60">
                  {service}
                </div>
              ))}
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-white">vikas@growthguy.in</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-white">+91-9595479090</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-white">India & Global</div>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="border-t border-white/[0.05] mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4"
        >
